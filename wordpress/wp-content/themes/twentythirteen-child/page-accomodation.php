					...
					<p>
						...
						<div class="accomodation-image-container">
							<div id="navcontainer">
								<ul>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>-child/images/accomodation/bedroom1_pic.png" alt="1 Bedroom"/><br/>
										<span class="accomodation-image-label">寝室1</span>
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>-child/images/accomodation/bedroom2_pic.png" alt="2 Bedrooms"/><br/>
										<span class="accomodation-image-label">寝室2</span>
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>-child/images/accomodation/kitchen_pic.png" alt="Kitchen"/><br/>
										<span class="accomodation-image-label">キッチン</span>
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>-child/images/accomodation/cr_pic.png" alt="Toilet"/><br/>
										<span class="accomodation-image-label">トイレ</span>
									</li>
									<li>
										<img src="<?php echo get_template_directory_uri(); ?>-child/images/accomodation/terrace_pic.png" alt="Balcony"/><br/>
